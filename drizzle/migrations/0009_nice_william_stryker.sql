...
ALTER TABLE "workflow_licenses" ADD CONSTRAINT "workflow_licenses_workflow_id_workflows_id_fk" FOREIGN KEY ("workflow_id") REFERENCES "public"."workflows"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
